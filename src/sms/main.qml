                    ...
                    delegate: Row {
                        ...
                        Rectangle {
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    current_id = id
                                    message_model.contact = id + ":" + name + ":" + me
                                    //currentIndex = -1
                                }
                            }
                        }
                ...
                ListView {
                    ...
                    delegate: Row {
                        ...
                        Rectangle {
                            ...
                            height: 24
                            color: short_background
                            visible: !(sent_by_me || sent_by_current)
                            Label {
                                anchors.centerIn: parent
                                text: short_from
                                color: short_color
                        ...
                        Rectangle {
                            ...
                            readonly property int widthCorrect: sent_by_current ? 25 : 0
                            radius: 5
                            height: bodyTop + (text_field.paintedHeight < 25 ? 25 : text_field.paintedHeight + 4)
                            width: text_field.width < 170 ? 180 : text_field.width + 10 + (sent_by_me && sended ? 16 : 0)
                            color: sent_by_me ? "white" : "#e3e3e3"
                            text: body
                            Label {
                                leftPadding: 3
                                y: 0
                            ...
                            TextEdit {
                                ...
                                width: dummy_text.paintedWidth > messages.width - 26 - (sent_by_me && sended ? 16 : 0)
                                       ? messages.width - 26 - (sent_by_me && sended ? 16 : 0)
                            ...
                            /*Rectangle {
                                ...
                                anchors.right: parent.right
                                height: 16
                                width: (sent_by_me && sended) ? 16 : 0
                                color: "transparent"
                                Image {
                                    anchors.fill: parent
                                    source: "images/checkg.png"
                                    visible: sent_by_me && sended
                                }
                            }*/
                        }
