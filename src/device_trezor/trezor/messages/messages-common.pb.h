...
#undef minor
#endif
#define PROTOBUF_INTERNAL_EXPORT_protobuf_messages_2dcommon_2eproto 
...
const ButtonRequest_ButtonRequestType ButtonRequest_ButtonRequestType_ButtonRequestType_MAX = ButtonRequest_ButtonRequestType_ButtonRequest_PassphraseEntry;
...
class Success : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hw.trezor.messages.common.Success) */ {
 public:
  Success();
  virtual ~Success();
 ...
 private:
  ...
  friend struct ::protobuf_messages_2dcommon_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class Failure : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hw.trezor.messages.common.Failure) */ {
 public:
  Failure();
  virtual ~Failure();
  ...
  inline Failure* New() const final {
    return CreateMaybeMessage<Failure>(NULL);
  }
...
class ButtonRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hw.trezor.messages.common.ButtonRequest) */ {
 public:
  ButtonRequest();
  ...
  inline ButtonRequest* New() const final {
    return CreateMaybeMessage<ButtonRequest>(NULL);
  }
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const ButtonRequestType _Deprecated_ButtonRequest_PassphraseType =
  ...
  static const ButtonRequestType ButtonRequest_PassphraseEntry =
...
class ButtonAck : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hw.trezor.messages.common.ButtonAck) */ {
 public:
  ButtonAck();
  virtual ~ButtonAck();
  ...
  inline ButtonAck* New() const final {
    return CreateMaybeMessage<ButtonAck>(NULL);
  }
...
class PinMatrixRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hw.trezor.messages.common.PinMatrixRequest) */ {
 public:
  PinMatrixRequest();
  ...
  inline PinMatrixRequest* New() const final {
    return CreateMaybeMessage<PinMatrixRequest>(NULL);
  }
...
class PinMatrixAck : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hw.trezor.messages.common.PinMatrixAck) */ {
 public:
  PinMatrixAck();
  ...
  inline PinMatrixAck* New() const final {
    return CreateMaybeMessage<PinMatrixAck>(NULL);
  }
...
class PassphraseRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hw.trezor.messages.common.PassphraseRequest) */ {
 public:
  PassphraseRequest();
  ...
  inline PassphraseRequest* New() const final {
    return CreateMaybeMessage<PassphraseRequest>(NULL);
  }
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool has__on_device() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void clear__on_device();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const int kOnDeviceFieldNumber = 1;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool _on_device() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set__on_device(bool value);

  // @@protoc_insertion_point(class_scope:hw.trezor.messages.common.PassphraseRequest)
 private:
  void set_has__on_device();
  void clear_has__on_device();
...
class PassphraseAck : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hw.trezor.messages.common.PassphraseAck) */ {
 public:
  PassphraseAck();
  ...
  inline PassphraseAck* New() const final {
    return CreateMaybeMessage<PassphraseAck>(NULL);
  }
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool has__state() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void clear__state();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const int kStateFieldNumber = 2;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR const ::std::string& _state() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set__state(const ::std::string& value);
  #if LANG_CXX11
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set__state(::std::string&& value);
  #endif
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set__state(const char* value);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set__state(const void* value, size_t size);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* mutable__state();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* release__state();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_allocated__state(::std::string* _state);

  // optional bool on_device = 3;
  bool has_on_device() const;
  void clear_on_device();
  static const int kOnDeviceFieldNumber = 3;
 ...
 private:
  ...
  void set_has_on_device();
  void clear_has_on_device();
...
class Deprecated_PassphraseStateRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hw.trezor.messages.common.Deprecated_PassphraseStateRequest) */ {
 public:
  ...
  void Swap(Deprecated_PassphraseStateRequest* other);
  ...
  inline Deprecated_PassphraseStateRequest* New() const final {
    return CreateMaybeMessage<Deprecated_PassphraseStateRequest>(NULL);
  }

  Deprecated_PassphraseStateRequest* New(::google::protobuf::Arena* arena) const final {
...
class Deprecated_PassphraseStateAck : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hw.trezor.messages.common.Deprecated_PassphraseStateAck) */ {
 public:
  ...
  void Swap(Deprecated_PassphraseStateAck* other);
  ...
  inline Deprecated_PassphraseStateAck* New() const final {
    return CreateMaybeMessage<Deprecated_PassphraseStateAck>(NULL);
  }

  Deprecated_PassphraseStateAck* New(::google::protobuf::Arena* arena) const final {
...
class HDNodeType : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hw.trezor.messages.common.HDNodeType) */ {
 public:
  HDNodeType();
  virtual ~HDNodeType();
  ...
  inline HDNodeType* New() const final {
    return CreateMaybeMessage<HDNodeType>(NULL);
  }
...
inline void PassphraseRequest::set_has__on_device() {
  _has_bits_[0] |= 0x00000001u;
}
inline void PassphraseRequest::clear_has__on_device() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void PassphraseRequest::clear__on_device() {
  _on_device_ = false;
  clear_has__on_device();
}
...
inline void PassphraseAck::set_has__state() {
  _has_bits_[0] |= 0x00000002u;
}
inline void PassphraseAck::clear_has__state() {
  _has_bits_[0] &= ~0x00000002u;
}
...
inline ::std::string* PassphraseAck::release__state() {
  ...
  clear_has__state();
  return _state_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline void PassphraseAck::set_has_on_device() {
  _has_bits_[0] |= 0x00000004u;
}
inline void PassphraseAck::clear_has_on_device() {
  _has_bits_[0] &= ~0x00000004u;
}
...
inline void Deprecated_PassphraseStateRequest::set_has_state() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Deprecated_PassphraseStateRequest::clear_has_state() {
  _has_bits_[0] &= ~0x00000001u;
}
