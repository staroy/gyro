...
contact_model::contact_model(sms *s, const std::string& path)
...
void contact_model::add(std::string id, std::string name, std::string key, std::string me)
{
...
sort_contact_model::sort_contact_model(sms *s, const std::string& path)
